...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "5789720944:AAEgifSYnOnqHml5FPhuIuxYnqky22f5MzY1")
...
#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://AMERICAN:ULTRA123@cluster0.2qwwxm1.mongodb.net/?retryWrites=true&w=majority")
DB_NAME = os.environ.get("DATABASE_NAME", "Emilia")

#force sub channel id, if you want enable force sub
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1001886813820"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1001848901512"))
